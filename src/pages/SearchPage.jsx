...
export const SearchPage = () => {
  ...
  useEffect(() => {
    const datos = [
      {
        id: "4f823724-4c6e-4870-8289-ffbeb72b601c",
        title: "Casa de Eric y Maria",
        bathrooms: 4,
        bedrooms: 6,
        city: "El Saman",
        price: 6000,
      ...
      {
        id: "2ee00d92-c0d6-408c-b50e-612886580357",
        title: "Casa de Alejandro",
        bathrooms: 4,
        bedrooms: 6,
        city: "Puerto la Cruz",
        price: 1500,
      ...
      {
        id: "0e8415f9-0e29-4057-a89f-e513874031aa",
        title: "Casa de Chuchu ",
        bathrooms: 4,
        bedrooms: 6,
        city: "Puerto la Cruz",
        price: 2000,
      ...
      {
        id: "1c8238db-2c2f-4141-a992-a862d3171b0e",
        title: "UDO",
        bathrooms: 4,
        bedrooms: 6,
        city: "Barcelona",
      ...
      {
        id: "ea8c4ce8-71be-41a0-9ad5-0a66b9eb226b",
        title: "Casa de Christian & Oriana",
        bathrooms: 4,
        bedrooms: 6,
        city: "Barcelona",
        price: 3700,
      ...
      {
        id: "0264b3d4-fab0-4b57-92a4-7513c3f867e6",
        title: "Casa de Clichita",
        bathrooms: 4,
        bedrooms: 6,
        city: "Los Cerezos",
        price: 7000,
